...
export default async function ProjectPage({ params }: Props) {
  ...
  // 2. Find the project by comparing slugs
      ...
      <main>
        ...
        <section className="pt-28 pb-0 bg-[var(--brand-cream)]">
          <div className="max-w-7xl mx-auto px-6 pb-12">
            {/* 3. Link back to the plural "portfolios" category page */}
            <Link
            ...
            <div className="grid md:grid-cols-3 gap-12">
              ...
              <div>
                ...
                <div className="mt-10">
                  ...
                  {/* Your personal email here is a nice touch! */}
                  <a
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {others.map((p) => (
                <Link
                  key={p.id}
                  // 4. Update the "More projects" link to point to singular /portfolio
