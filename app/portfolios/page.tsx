      ...
      <main>
        ...
        <section className="pt-32 pb-16 bg-[var(--brand-cream)]">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <h1 className="font-serif text-6xl md:text-7xl font-bold text-foreground mt-3 mb-6">
              Selected work
            </h1>
            <p className="text-muted-foreground text-lg max-w-xl">
              A curated collection of brand identities, digital experiences, and visual stories.
            </p>
          </div>
        </section>
